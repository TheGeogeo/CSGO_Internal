...
namespace hazedumper {
	...
	namespace signatures {
		...
		constexpr ptrdiff_t dwEntityList = 0x4DDB92C;
		constexpr ptrdiff_t dwForceAttack = 0x320BE10;
		constexpr ptrdiff_t dwForceAttack2 = 0x320BE1C;
		constexpr ptrdiff_t dwForceBackward = 0x320BE64;
		constexpr ptrdiff_t dwForceForward = 0x320BE58;
		constexpr ptrdiff_t dwForceJump = 0x52858A8;
		constexpr ptrdiff_t dwForceLeft = 0x320BE70;
		constexpr ptrdiff_t dwForceRight = 0x320BE7C;
		constexpr ptrdiff_t dwGameDir = 0x62B900;
		constexpr ptrdiff_t dwGameRulesProxy = 0x52F90CC;
		constexpr ptrdiff_t dwGetAllClasses = 0xDE9CAC;
		constexpr ptrdiff_t dwGlobalVars = 0x58CCE0;
		constexpr ptrdiff_t dwGlowObjectManager = 0x5324588;
		constexpr ptrdiff_t dwInput = 0x522CF00;
		constexpr ptrdiff_t dwInterfaceLinkList = 0x96E944;
		constexpr ptrdiff_t dwLocalPlayer = 0xDBF4CC;
		constexpr ptrdiff_t dwMouseEnable = 0xDC51D8;
		constexpr ptrdiff_t dwMouseEnablePtr = 0xDC51A8;
		constexpr ptrdiff_t dwPlayerResource = 0x320A190;
		constexpr ptrdiff_t dwRadarBase = 0x52106A4;
		constexpr ptrdiff_t dwSensitivity = 0xDC5074;
		constexpr ptrdiff_t dwSensitivityPtr = 0xDC5048;
		constexpr ptrdiff_t dwSetClanTag = 0x8A410;
		constexpr ptrdiff_t dwViewMatrix = 0x4DCD244;
		constexpr ptrdiff_t dwWeaponTable = 0x522D9C4;
		constexpr ptrdiff_t dwWeaponTableIndex = 0x326C;
		constexpr ptrdiff_t dwYawPtr = 0xDC4E38;
		constexpr ptrdiff_t dwZoomSensitivityRatioPtr = 0xDCB620;
		constexpr ptrdiff_t dwbSendPackets = 0xD8422;
		constexpr ptrdiff_t dwppDirect3DDevice9 = 0xA6050;
		constexpr ptrdiff_t find_hud_element = 0x2DFF59D0;
		constexpr ptrdiff_t force_update_spectator_glow = 0x3BDCEA;
		constexpr ptrdiff_t interface_engine_cvar = 0x3EA3C;
		constexpr ptrdiff_t is_c4_owner = 0x3CAD70;
		...
		constexpr ptrdiff_t m_pitchClassPtr = 0x5210940;
		constexpr ptrdiff_t m_yawClassPtr = 0xDC4E38;
